...
<div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-3">Rp. 78,250 <span class="badge bg-light-success border border-success"><i
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Paid</h6>
                            <h4 class="mb-3">Rp. 18,800 <span class="badge bg-light-warning border border-warning"><i
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Not Paid</h6>
                            <h4 class="mb-3">Rp. 87,000<span class="badge bg-light-danger border border-danger"><i
                                        class="ti ti-trending-down"></i> 27.4%</span></h4>
